...
import { getAllArtworksAPI } from "../../Service/allApi"; // ✅ Fetch artworks from server

function Collection() {
  const dispatch = useDispatch();
  const [artworks, setArtworks] = useState([]);

  // ✅ Load artworks from JSON Server
  useEffect(() => {
        ...
        <div className="container">
          ...
          <div className="text-center mb-5">
            ...
            <p className="text-secondary">
              Discover artworks uploaded by our talented artists — where creativity meets eternity.
            </p>
          </div>
          ...
          <div className="row g-4 justify-content-center">
            {artworks.length > 0 ? (
              artworks.map((art) => (
                <div key={art.id} className="col-sm-6 col-md-4 col-lg-3">
                  <div
                  ...
                  >
                    ...
                    <div className="card-body">
                      <h5 className="fw-semibold text-white">{art.title}</h5>
                      <p
